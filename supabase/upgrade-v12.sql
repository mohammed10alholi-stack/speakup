-- upgrade-v12: تجميع v9 + v10 (آمن تشغيله أكثر من مرة) + تسمية باقات الدقائق نجوم
...
-- باقات الدقائق صارت نجوم توكي (كل نجمة = دقيقة)
update public.minute_packs set name = minutes || ' نجمة ⭐' where coalesce(kind,'minutes') = 'minutes';
